...
class Device:
    ...
    def __init__(
            ...
            stream_callback: Callable[[Device, Device.MeasurementType, np.ndarray, np.ndarray], None] | None = None,
            disconnect_callback: Callable[[Device], None] | None = None
        ) -> None:
        """
        Args:
...
class Manager:
    ...
    def __init__(self, save_dir: Path, stream_callback: Callable[[Device, Device.MeasurementType, np.ndarray, np.ndarray], None] | None, loglevel: Device.LogLevel = Device.LogLevel.INFO) -> None:
        """
        Args:
            save_dir: Directory passed through to each captured Device.
            stream_callback: Passed through to each captured Device.
            loglevel: Passed through to each captured Device.
        """
    ...
    def disconnect_callback(self, polar_device: Device) -> None:
